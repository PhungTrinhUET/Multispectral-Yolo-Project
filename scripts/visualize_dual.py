...
def find_ndvi_file(rgb_filename, ndvi_base_dir):
    """Tìm file NDVI tương ứng dựa trên tên file RGB (bỏ qua đuôi file). Ví dụ: RGB='abc.jpg' -> Tìm 'abc.png',
    'abc.tif', 'abc.jpg' trong folder NDVI.
    """
...
def run_predict():
    ...
    image_files = list(rgb_path_obj.glob("*.jpg")) + list(rgb_path_obj.glob("*.png")) + list(rgb_path_obj.glob("*.tif"))
