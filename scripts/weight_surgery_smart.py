...
def perform_smart_surgery():
    ...
    rgb_map = {
        ...
        3: 2,  # Stem
        7: 3,
        8: 4,  # P3 (Target 256 khớp Source 256)
        15: 5,
        16: 6,  # P4 (Target 512 khớp Source 512)
        23: 7,
        24: 8,
        25: 9,  # P5 (Target 512 khớp Source 512)
    }
    ...
    nir_map = {
        4: 0,
        5: 1,
        6: 2,  # Stem (Layer 4 sẽ được nén kênh 3->1)
        9: 3,
        10: 4,  # P3
        17: 5,
        18: 6,  # P4
    ...
    for key in new_sd.keys():
        ...
        if layer_idx in rgb_map:
            ...
            if src_key_short in rgb_sd:
                src_key = src_key_short
            elif src_key_long in rgb_sd:
                src_key = src_key_long
            else:
                src_key = None
        ...
        # 2. XỬ LÝ NHÁNH NIR
            ...
            if src_key_short in nir_sd:
                src_key = src_key_short
            elif src_key_long in nir_sd:
                src_key = src_key_long
            else:
                src_key = None
